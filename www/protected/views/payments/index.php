                ...
                <article data-bind="css: {'opened': opened}">
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="cell-date">
                                    ...
                                    <span class="date"><span><?=$factDate?><br><?=$this->getMonthForTable($month)?></span><br><span class="day"
                    ...
                    <table class='prices'>
                        ...
                        <tr>
                            ...
                            <th class="cell-name" colspan="8" style="background: #dcba9d;">ФОТ Столярный участок</th>
                            <th class="cell-name" rowspan="2" style="background: #d9e5bd;">ФОТ Брус</th>
                            <th class="cell-name" colspan="5" style="background: #b8cce4;">ФОТ Металлообработки</th>
                        </tr>
                        <tr>
